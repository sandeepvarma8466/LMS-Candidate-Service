package com.blz.candidateservice.config;
...
public class SpringFoxConfig implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.blz.candidateservice.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("CandidateService",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("CandidateService", "http://bridgelabz.lms", "svarma852@gmail.com"),
                "Apache 2.0",
